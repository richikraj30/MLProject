...
class ModelTrainerConfig:
    trined_model_file_path = os.path.join("artifacts", "model.pkl")
    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            ...
            X_train, Y_train, X_test, Y_test = (
                train_array[:,:-1], #retrieves all the data except the last column
                train_array[:,-1], #retrieves the last column
                test_array[:,:-1],
                test_array[:,-1],
            )
            ...
            save_object(
                file_path=self.model_trainer_config.trined_model_file_path,
                obj=best_model
            )
